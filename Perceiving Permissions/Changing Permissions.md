...
### Solve
**Flag:** `pwn.college{oh3_YKd-vzpJr8xlAr0qcllzf6K.QXzcjM1wSNyMzNzEzW}`

In this level we will be allowed to use `chmod` without root access. We can grant read permission for `/flag` to all users, using `chmod a+r /flag`.

```
chmod a+r /flag
cat /flag
pwn.college{oh3_YKd-vzpJr8xlAr0qcllzf6K.QXzcjM1wSNyMzNzEzW}
```
### New Learnings
